...
wd = webdriver.Edge(executable_path="C:\\edgedriver_win64\\msedgedriver.exe")
print(wd.title)
...
try:
    ...
    time.sleep(3)
    wd.find_element_by_name('Name').send_keys('Dhanashreee P')
    time.sleep(3)
    wd.find_element_by_name('Email').send_keys('pastedhanashree@gmail.com')
    time.sleep(3)
